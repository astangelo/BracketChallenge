...
class UserEntriesControllerTest < ActionController::TestCase
  ...
  test "should create user_entry" do
    assert_difference('UserEntry.count') do
      post :create, user_entry: { active: @user_entry.active, challenge_id: @user_entry.challenge_id, user_id: @user_entry.user_id }
    end
  ...
  test "should update user_entry" do
    patch :update, id: @user_entry, user_entry: { active: @user_entry.active, challenge_id: @user_entry.challenge_id, user_id: @user_entry.user_id }
    assert_redirected_to user_entry_path(assigns(:user_entry))
  end
